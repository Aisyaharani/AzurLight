        ...
        <div class="order">
          ...
          <form action="" class="form-horizontal" id="form" method="post">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nama_category" name="nama_category" value="<?= $category['NAMA_CATEGORY'] ?>">
              </div>
            </div>
            <div class=" mb-3 row">
              ...
              <div class="col-sm-10">
                <select class="form-select" id="is_active" name="is_active" required>
                  <option value="Y" <?php echo ($category['IS_ACTIVE'] == 'Y' ? ' selected' : ''); ?>>Ya</option>
                  <option value="N" <?php echo ($category['IS_ACTIVE'] == 'N' ? ' selected' : ''); ?>>No</option>
                </select>
              </div>
            </div>
